...
export default function CategoryCard({ category }: { category: Category }) {
  ...
  return (
    <Link
      ...
      className="group flex items-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-xl hover:border-[#059669] hover:bg-emerald-50/30 transition-all"
    >
      <div className="w-9 h-9 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0">
        <Icon size={17} className="text-gray-800" />
      </div>
      <div className="flex-1 min-w-0">
        <p className="font-semibold text-gray-900 text-sm leading-tight group-hover:text-[#059669] transition-colors">
