        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 bg-[#C84B31] rounded-md flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-xs text-gray-500 hover:text-[#C84B31]">
                    {t(l.en, l.bn)}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {["Dhaka", "Chattogram", "Rajshahi", "Sylhet", "Khulna"].map((d) => (
                <li key={d}>
                  <Link href={`/doctors?division=${d}`} className="text-xs text-gray-500 hover:text-[#C84B31]">
                    {d}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-xl font-bold text-[#C84B31] mt-1">16457</p>
